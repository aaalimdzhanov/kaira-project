...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.productValue.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-values.update", [$productValue->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_ids') ? 'is-invalid' : '' }}" name="product_ids_id" id="product_ids_id" required>
                    @foreach($product_ids as $id => $entry)
                        <option value="{{ $id }}" {{ (old('product_ids_id') ? old('product_ids_id') : $productValue->product_ids->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $productValue->price) }}" step="0.01" required>
                @if($errors->has('price'))
                    <div class="invalid-feedback">
                        {{ $errors->first('price') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('initial_price') ? 'is-invalid' : '' }}" type="number" name="initial_price" id="initial_price" value="{{ old('initial_price', $productValue->initial_price) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('old_price') ? 'is-invalid' : '' }}" type="number" name="old_price" id="old_price" value="{{ old('old_price', $productValue->old_price) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}" type="number" name="discount" id="discount" value="{{ old('discount', $productValue->discount) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('discount_start') ? 'is-invalid' : '' }}" type="text" name="discount_start" id="discount_start" value="{{ old('discount_start', $productValue->discount_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('discount_end') ? 'is-invalid' : '' }}" type="text" name="discount_end" id="discount_end" value="{{ old('discount_end', $productValue->discount_end) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stock') ? 'is-invalid' : '' }}" type="number" name="stock" id="stock" value="{{ old('stock', $productValue->stock) }}" step="1" required>
                @if($errors->has('stock'))
                    <div class="invalid-feedback">
                        {{ $errors->first('stock') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('color') ? 'is-invalid' : '' }}" name="color_id" id="color_id" required>
                    @foreach($colors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('color_id') ? old('color_id') : $productValue->color->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('color'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('size') ? 'is-invalid' : '' }}" name="size_id" id="size_id" required>
                    @foreach($sizes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('size_id') ? old('size_id') : $productValue->size->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('size'))
                    <div class="invalid-feedback">
