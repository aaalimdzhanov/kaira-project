...
class MaterialController extends Controller
{
    public function index()
    {
        ...
        $materials = Material::with(['category_ids'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.materials.create', compact('category_ids'));
    }
    ...
    public function edit(Material $material)
    {
        ...
        $material->load('category_ids');

        return view('admin.materials.edit', compact('category_ids', 'material'));
    }
